...
//
//     final myPageDetailmod = myPageDetailmodFromJson(jsonString);

import 'dart:convert';

MyPageDetailmod myPageDetailmodFromJson(String str) => MyPageDetailmod.fromJson(json.decode(str));

String myPageDetailmodToJson(MyPageDetailmod data) => json.encode(data.toJson());

class MyPageDetailmod {
    int status;
    Data data;
    ...
    factory MyPageDetailmod.fromJson(Map<String, dynamic> json) => MyPageDetailmod(
        status: json["status"],
